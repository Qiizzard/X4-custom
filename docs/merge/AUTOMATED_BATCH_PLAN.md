...
| P7 | in progress | Matrix Rain, Voronoi and simplified Chess integrated (wip). Remaining approved defense, comms, games and settings features; skip unresolved BLE/hardware/product choices and record them briefly. |
