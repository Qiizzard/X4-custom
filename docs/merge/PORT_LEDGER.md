...
| Legacy radio migration | `wip` | Sites 1–6 source integrated; shared picker authorization integrated; picker SDK operations, legacy handoff and OTA remain. Runtime/device validation deferred to V1. `acquire()` refuses foreign sessions. See `RADIO_MIGRATION.md`. |
...
Latest verified full working-snapshot image (2026-09-19 UTC, P5 picker authorization checkpoint):

| Quantity | Bytes |
|---|---:|
| Firmware image (`firmware.bin`) | 6,394,976 |
| Smallest configured OTA app slot | 6,553,600 |
| Free space | 158,624 |
| Warning reserve | 262,144 |
| Shortfall against reserve | 103,520 |
